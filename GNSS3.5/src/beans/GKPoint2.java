...
//		try {
//			point.setSpatialReferenceByRef(ArcgisHelper.projectedCoordinateSystem);
//		} catch (IOException e) {
//			e.printStackTrace();
//		}
//	}
...
//	 * @return
//	 */
//	public GKPoint2 getPointCopy() {
//		GKPoint2 copyPoint = new GKPoint2();
//		try {
...
//		GKPoint2 point = this.getPointCopy();
//		try {
...
//	 * @param H BLH中的H值
//	 */
//	public GKPoint2(double X, double Y, double H){
//		this.point = ArcgisHelper.getPointInstance();
//		try {
//			point.setSpatialReferenceByRef(ArcgisHelper.projectedCoordinateSystem);
//			point.setX(X);
