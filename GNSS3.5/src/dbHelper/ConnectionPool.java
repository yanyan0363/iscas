...
public class ConnectionPool {
    ...
    private Vector connections = new Vector<>(); // 存放连接池中数据库连接的向量 , 初始时为 null,它中存放的对象为 PooledConnection 型
    private static ConnectionPool connectionPool = null;

//    private static Logger logger = Logger.getLogger(ConnectionPool.class);
    /**
     * 构造函数，根据config.propertes配置文件中构造
     */
    private ConnectionPool() {
    	this.jdbcDriver = PropertyDB.getStringProperty("jdbcDriver");
        this.dbUrl = PropertyDB.getStringProperty("dbUrl");
        this.dbUsername = PropertyDB.getStringProperty("dbUser");
        this.dbPassword = PropertyDB.getStringProperty("dbPassword");
        this.initialConnections = PropertyDB.getIntProperty("innitialConnections");
        this.incrementalConnections = PropertyDB.getIntProperty("incrementalConnections");
        this.maxConnections = PropertyDB.getIntProperty("maxConnections");
	}
    /**
     * 构造函数
     * 
...
//        Driver driver = (Driver) (Class.forName(this.jdbcDriver).newInstance());
		...
		try {
			...
			System.err.println("创建数据库连接池失败！@" + e.getMessage());
//			logger.error("创建数据库连接池失败！@" + e.getMessage());
			connectionPool = null;
			e.printStackTrace();
		}// 注册 JDBC 驱动程序
...
//            System.out.println("this.maxConnections:" + this.maxConnections);
//            System.out.println("this.connections.size():" + this.connections.size());
//            System.out.println("this.maxConnections:" + this.maxConnections);
